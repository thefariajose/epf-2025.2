    ...
    <div class="section-header">
        ...
        ">
            <span style="font-weight: 600; color: var(--primary-color);">
                <i class="fas fa-user-circle" style="margin-right: 6px; color: var(--accent-color);"></i>
                Olá, {{cliente.name}}!
            </span>

            <a href="/cliente/perfil" style="color: var(--primary-color);">
                <i class="fas fa-user-edit"></i> Editar Perfil
            </a>

            <a href="/cliente/meus_alugueis" style="color: var(--accent-color);">
                <i class="fas fa-receipt"></i> Meus Aluguéis
            </a>
        </div>
    </div>
